...
data  = np.load("D:/NCKH2023-2024/Monitoring Student/Attendance/Diemdanh/model/faces-dataset.npz")
...
if __name__ == "__main__":
    ...
    #Save model
    filename = 'D:/NCKH2023-2024/Monitoring Student/Attendance/Diemdanh/model/classify.sav'
