...
#Define url
root_url = r"D:/NCKH2023-2024/Monitoring Student/Attendance/Diemdanh" #Change root_url according to computer directory
root_raw_img = r"D:/NCKH2023-2024/Monitoring Student/Attendance/Diemdanh/raw_images"
detector = MTCNN()
