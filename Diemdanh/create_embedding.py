...
data = np.load('D:/NCKH2023-2024/Monitoring Student/Attendance/Diemdanh/model/faces-dataset.npz',allow_pickle=True)
train_X, train_y, test_X, test_y = data['a'], data['b'], data['c'], data['d']

# get the face embedding for one face
def get_embedding(model1, face_pixels):
	# scale pixel values
...
if __name__ == "__main__":
    ...
    np.savez_compressed("D:/NCKH2023-2024/Monitoring Student/Attendance/Diemdanh/model/faces-dataset.npz", a = embed_trainX, b = train_y, c = embed_testX, d = test_y)
